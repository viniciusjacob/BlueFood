package com.bluefood.application.test;
...
public class InsertDataForTesting {
	...
	private void categorias(){
		...
		c.setNome("Pizza");
		c.setImagem("0001-categoria.png");
		categoriaRestauranteRepository.save(c);

		c = new CategoriaRestaurante();
		c.setNome("Sanduíche");
		c.setImagem("0002-categoria.png");
		categoriaRestauranteRepository.save(c);

		c = new CategoriaRestaurante();
		c.setNome("Churrasco");
		c.setImagem("0003-categoria.png");
		categoriaRestauranteRepository.save(c);

		c = new CategoriaRestaurante();
		c.setNome("Salada");
		c.setImagem("0004-categoria.png");
		categoriaRestauranteRepository.save(c);

		c = new CategoriaRestaurante();
		c.setNome("Sobremesa");
		c.setImagem("0005-categoria.png");
		categoriaRestauranteRepository.save(c);

		c = new CategoriaRestaurante();
		c.setNome("Japonês");
		c.setImagem("0006-categoria.png");
		categoriaRestauranteRepository.save(c);
	}
